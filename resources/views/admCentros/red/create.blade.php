  ...
  <div class="col-sm-12 col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border">
          <h3 align="center">PANEL DE REGISTRO DE <span class="text-bold">REDES</span></h3>
          ...
          <div class="panel-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 col-md-6 col-dm-6 col-xs-12">
              	<div class="form-group">
              	   <label for="id_nivel">IMAGEN: </label>
                   <textarea required="required" class="autosize form-control" id="form-field-24" name="image"></textarea>
              	</div>
              </div>
            </div>
            <br>
            ...
            <div class="col-sm-8 col-sm-offset-2" id="guardar">
             <div class="form-group">
               <button class="btn btn-primary btn-block" type="submit">
                 REGISTRAR RED <i class="fa fa-arrow-circle-right"></i>
               </button>
             </div>
            </div>
          {!! Form::close() !!}
