...
<section class="content-header">
  <h1 align="center">
    <b>ROL DE TURNO - ETAPA EMERGENCIA</b>
  </h1>
  <ol class="breadcrumb">
  ...
  <div class="col-sm-12 col-xs-12">
    <div class="box box-success">
      <div class="box-header with-border">
      	<h3 align="center">PANEL DE EDICION DE <span class="text-bold">ROL DE TURNO - ETAPA DE EMERGENCIA</span></h3>
      	<br>
        ...
        <div>
            <div class="panel panel-info">
              <div class="panel-heading">ROL DE TURNO - ETAPA DE EMERGENCIA</div>
             ...
             <div class="col-sm-8 col-sm-offset-2">
               <div class="form-group">
                   ...
                   <i class="fa fa-arrow-circle-right"> EDITAR ETAPA DE EMERGENCIA </i>
                </button>
               </div>
             </div>
        </div>
	...
	while ( c < rol_dias.length ){
		...
		if (turnos[i]['id'] == rol_dias[c]['id_turno']) {
			...
			var fila_observacion = '<div id="fila_observacion'+cont+'" style="padding-bottom: 10px;">'+
				...
				'</div>';
				// console.log(c);
			var fila_opcion = '<div style="margin-bottom: 10px;" id="fila_op'+cont+'"><button type="button" class="btn btn-danger" onclick="eliminarFila('+cont+','+turnos[i]['id']+','+turnos[i]['id_detalle_centro_especialidad']+','+detalle_turnos[(c / 7)-1]['id']+');"><i class="fa fa-close"></i></button><br></div>';
