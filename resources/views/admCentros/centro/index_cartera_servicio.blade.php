             ...
             @foreach($cartera_servicios as $var)
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a href="{{ route('edit-cartera-servicio',[$var->id,$centro->id]) }}" class="btn btn-info" data-placement="top" data-original-title="Ver Detalle de Orden de Produccion"><i class="fa fa-edit"></i></a>
                      ...
                      <a href="{{ route('renovate-cartera-servicio',[$var->id,$centro->id] ) }}" class="btn btn-warning" data-placement="top" data-original-title="Ver Detalle de Orden de Produccion"><i class="fa fa-refresh"></i></a>
                    </td>
                  </tr>
