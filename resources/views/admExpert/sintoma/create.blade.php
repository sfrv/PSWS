  ...
  <div class="col-sm-12 col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border">
          <h3 align="center">Panel de control de <span class="text-bold">Sintomas</span></h3>

          <div class="panel-body">
            {!!Form::open(array('url'=>'adm/sintoma','method'=>'POST','autocomplete'=>'off'))!!}
  			    {{Form::token()}}
            ...
            <div class="col-sm-8 col-sm-offset-2" id="guardar">
             <div class="form-group">
               <button class="btn btn-primary btn-block" type="submit">
                 Registrar Sintoma <i class="fa fa-arrow-circle-right"></i>
               </button>
             </div>
            </div>
          {!! Form::close() !!}
