  ...
  <div class="col-sm-12 col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border">
          <h3 align="center">Panel de control de <span class="text-bold">Enfermedad</span></h3>

          <div class="panel-body">
            {!!Form::open(array('url'=>'adm/enfermedad','method'=>'POST','autocomplete'=>'off'))!!}
  			    {{Form::token()}}
            ...
            <div class="panel panel-info">
              ...
              <div class="col-lg-12 col-md-6 col-dm-12 col-xs-12">
              	<div class="form-group">
              		...
              		<select name="pidsintoma" id="pidsintoma" class="form-control">
              			<option></option>
            ...
            <div class="col-sm-8 col-sm-offset-2" id="guardar">
             <div class="form-group">
               <button class="btn btn-primary btn-block" type="submit">
                 Registrar Enfermedad <i class="fa fa-arrow-circle-right"></i>
               </button>
             </div>
            </div>
          {!! Form::close() !!}
...
function agregar()
   {
     idsintoma=$("#pidsintoma").val();
     sintoma=$("#pidsintoma option:selected").text();

     if (idsintoma!=""){
       var fila='<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idsintoma[]" value="'+idsintoma+'">'+sintoma+'</td></tr>';
       cont++;
       limpiar();
       evaluar();
